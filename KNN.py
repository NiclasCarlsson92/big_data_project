...
def main():
    ...
    # Looking for the 21 closest neighbours
    KNN_model = neighbors.KNeighborsClassifier(n_neighbors=21, n_jobs=-1)
    ...
    print("Accuracy={}%".format(f1_score(y_val, pred, average='macro')))
